...
f2tree.Draw('deta_highest2b>>h2(20,-3,)','(EVENT_rWeights[11]/EVENT_originalXWGTUP)*(angle_bbpp_highest2b>0&&(n_presel_jet>=3 && is_tH_like_and_not_ttH_like !=1 && HiggsDecay!=1))','same')
